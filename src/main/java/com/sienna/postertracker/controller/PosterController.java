...
public class PosterController {
	Logger log = Logger.getLogger(PosterController.class.getName());
	@Autowired
    ...
    @GetMapping("posters/get/teammates/{id}")
    public List<Poster> allTeammatesPosters(@PathVariable Long id) {  
		return repository.findTeammatesPosters(id);  	
    }
}
